...
--In this case srudy, I analyzed data from a Cyclist Bike-Share company for the year 2022. The stakeholders wanted to know how their members use there bike services and how casual members can be converted to annual members.
...
--CONCEPTS COVERED: --Creating a table and inserting data to it.
					--Union all.
					--CAST.
					--SELECT, FROM, WHERE, GROUP BY, ORDER BY clause.
...
--DATA FORMATING
--Adding ride_length, day_of_ride, month_of_ride and hour_of_the_day to our table
...
--bike types used by members_casual
...
Select top 764 end_station_name, member_casual, COUNT(ride_id) as total_rides
From yearly_bike_data
